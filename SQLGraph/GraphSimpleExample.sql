...
-- You can select the $NODE_ID from the node table and insert into the EDGE table, using an INSERT statement similar to one below: 
...
INSERT INTO WORKS_FOR VALUES((SELECT $NODE_ID FROM OPERATOR WHERE ID = 1), (SELECT $NODE_ID FROM FACTORY WHERE ID=8), '10/10/2010');
INSERT INTO WORKS_FOR VALUES((SELECT $NODE_ID FROM OPERATOR WHERE ID = 2), (SELECT $NODE_ID FROM FACTORY WHERE ID=8), '10/10/2010');
INSERT INTO WORKS_FOR VALUES((SELECT $NODE_ID FROM OPERATOR WHERE ID = 3), (SELECT $NODE_ID FROM FACTORY WHERE ID=8), '10/10/2010');
...
-- Let's list all the sensors that are reporting failure and machines affected by that.
